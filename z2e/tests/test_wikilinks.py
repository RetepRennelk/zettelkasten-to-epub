...
def test_md_files_outgoing_link():
    ...
    assert "ID5 This zettel embeds an image" in outlinks
    assert "ID6 Table" in outlinks
...
- [[ID6 Table]]""".split('\n')
    ...
    assert "ID5 This zettel embeds an image" in out_links
    assert "ID6 Table" in out_links
